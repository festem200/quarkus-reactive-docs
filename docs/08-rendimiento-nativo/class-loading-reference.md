...
> **Guia oficial:** <https://quarkus.io/guides/class-loading-reference>  
> **Fuente:** `docs/src/main/asciidoc/class-loading-reference.adoc` en [quarkusio/quarkus@3.38.2](https://github.com/quarkusio/quarkus/blob/3.38.2/docs/src/main/asciidoc/class-loading-reference.adoc)  
...
* QuarkusExtensionTest (Maven, Gradle and IDE)
...
![classloader-hierarchy](../_assets/classloader-hierarchy.png)
...
**📌 NOTE**\
La tabla de configuracion generada `quarkus-core_quarkus.class-loading` se produce al construir la documentacion y no existe en el codigo fuente. Consulta la referencia de configuracion en https://quarkus.io/guides/all-config
