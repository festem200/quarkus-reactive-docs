...
> **Guia oficial:** <https://quarkus.io/guides/getting-started-reactive>  
> **Fuente:** `docs/src/main/asciidoc/getting-started-reactive.adoc` en [quarkusio/quarkus@3.38.2](https://github.com/quarkusio/quarkus/blob/3.38.2/docs/src/main/asciidoc/getting-started-reactive.adoc)  
...
If you want to read more about these topics, refer to the [Reactive Architecture guide](quarkus-reactive-architecture.md), which provides an overview of the Quarkus reactive ecosystem.
...
Yet, unlike in the [Hibernate with Panache guide](https://quarkus.io/guides/hibernate-orm-panache), it uses the reactive features of Quarkus.
...
![blocking-threads](../_assets/blocking-threads.png)
...
To know more about Mutiny, check the [Mutiny documentation](mutiny-primer.md).
...
First, go to [code.quarkus.io](https://code.quarkus.io) and select the following extensions:

1. Quarkus REST Jackson
2. Hibernate Reactive with Panache
3. Reactive PostgreSQL client

![reactive-guide-code](../_assets/reactive-guide-code.png)
...
```
1. [Configure the datasource](../03-datos/datasource.md) for production, relying on [Dev Services](../03-datos/datasource.md#dev-services) for connection information in tests / dev mode.
...
If you have [curl](https://curl.se/) on your machine, you can try the endpoint using:
...
In [FruitsEndpointTest.java](https://github.com/quarkusio/quarkus-quickstarts/blob/main/hibernate-reactive-panache-quickstart/src/test/java/org/acme/hibernate/orm/panache/FruitsEndpointTest.java) you can see how the test for the fruit application can be implemented.
...
There are other ways to configure the application - please check the [configuration guide](config-reference.md#configuration-sources) to have an overview of the possibilities (such as env variable, .env files and so on).
...
* [The Quarkus Reactive Architecture](quarkus-reactive-architecture.md)
* [Mutiny - an intuitive reactive programming library](mutiny-primer.md)
