...
> **Guia oficial:** <https://quarkus.io/guides/quarkus-reactive-architecture>  
> **Fuente:** `docs/src/main/asciidoc/quarkus-reactive-architecture.adoc` en [quarkusio/quarkus@3.38.2](https://github.com/quarkusio/quarkus/blob/3.38.2/docs/src/main/asciidoc/quarkus-reactive-architecture.adoc)  
...
The [Reactive Manifesto](https://www.reactivemanifesto.org/) characterizes _Reactive Systems_ as distributed systems having four characteristics:
...
![reactive-systems](../_assets/reactive-systems.png)

In addition to this, the [Reactive Principles white paper](https://principles.reactive.foundation/) lists a set of rules and patterns to help the construction of reactive systems.
...
* Reactive Programming with [Mutiny](https://smallrye.io/smallrye-mutiny), and
* Coroutines with Kotlin

First, [Mutiny](https://smallrye.io/smallrye-mutiny) is an intuitive, event-driven reactive programming library.
...
Find more info about Mutiny and its usage in Quarkus on [Mutiny support documentation](mutiny-primer.md).
</dd></dl>
...
Quarkus implements a [proactor pattern](https://en.wikipedia.org/wiki/Proactor_pattern) that switches to worker thread when needed.

![The proactor pattern in Quarkus](../_assets/proactor-pattern.png)
...
Quarkus adds new features in every release, and the [Quarkiverse](https://github.com/quarkiverse) proposes many extensions enabling _Reactive_.
