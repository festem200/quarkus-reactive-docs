...
> **Guia oficial:** <https://quarkus.io/guides/duplicated-context>  
> **Fuente:** `docs/src/main/asciidoc/duplicated-context.adoc` en [quarkusio/quarkus@3.38.2](https://github.com/quarkusio/quarkus/blob/3.38.2/docs/src/main/asciidoc/duplicated-context.adoc)  
...
**📌 NOTE**\
This section is not an explanation of the reactive model. Refer to that [the Quarkus Reactive Architecture](quarkus-reactive-architecture.md) for more details.
...
These threads are named [event loops](https://en.wikipedia.org/wiki/Event_loop) and implement a [multi-reactor pattern](https://en.wikipedia.org/wiki/Reactor_pattern).
...
![reactive-continuation](../_assets/reactive-continuation.png)
...
The [MicroProfile Context Propagation](context-propagation.md) specification addresses this issue.
...
public String hello1() {
   ...
   return "Hello, you are running on context: %s and on thread %s".formatted(context, Thread.currentThread());  ①
}
...
![duplicated-context-continuation](../_assets/duplicated-context-continuation.png)
...
Check the [logging reference guide](../07-observabilidad/logging.md#mdc-propagation) for more details.
...
See the [Message Context](https://smallrye.io/smallrye-reactive-messaging/latest/concepts/message-context/) documentation for further information.
...
* [Quarkus Reactive Architecture](quarkus-reactive-architecture.md)
* [Vert.x Reactor and Multi-Reactor documentation](https://vertx.io/docs/vertx-core/java/#_reactor_and_multi_reactor)
* [Quarkus logging](../07-observabilidad/logging.md)
