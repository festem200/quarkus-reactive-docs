...
> **Guia oficial:** <https://quarkus.io/guides/software-transactional-memory>  
> **Fuente:** `docs/src/main/asciidoc/software-transactional-memory.adoc` en [quarkusio/quarkus@3.38.2](https://github.com/quarkusio/quarkus/blob/3.38.2/docs/src/main/asciidoc/software-transactional-memory.adoc)  
...
languages. We won’t go into all the details behind STM but the interested reader could look at [this paper](https://groups.csail.mit.edu/tds/papers/Shavit/ShavitTouitou-podc95.pdf).
...
Note that the STM implementation provided by Quarkus is based on the [Narayana STM](https://narayana.io/docs/project/index.html#d0e16066) implementation. This document isn’t meant to be a replacement for that project’s documentation, so you may want
...
Git repository: `git clone https://github.com/quarkusio/quarkus-quickstarts.git`, or by downloading an [archive](https://github.com/quarkusio/quarkus-quickstarts/archive/main.zip).
...
understand what these may be. Please refer to the [Narayana STM manual](https://narayana.io/docs/project/index.html#d0e16066)
and the [STM annotations guide](https://narayana.io//docs/project/index.html#d0e16133) for more details on
...
1. An object for manually controlling transaction boundaries (AtomicAction and many other useful
    ...
    Refer [to the javadoc](https://javadoc.io/doc/org.jboss.narayana.jta/narayana-jta/latest/com/arjuna/ats/arjuna/AtomicAction.html) for more detail.
...
described in the [Context Propagation guide](../01-fundamentos/context-propagation.md).
