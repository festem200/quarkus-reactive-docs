...
> **Guia oficial:** <https://quarkus.io/guides/lra-dev-services>  
> **Fuente:** `docs/src/main/asciidoc/lra-dev-services.adoc` en [quarkusio/quarkus@3.38.2](https://github.com/quarkusio/quarkus/blob/3.38.2/docs/src/main/asciidoc/lra-dev-services.adoc)  
...
The LRA Dev Services supports [Compose Dev Services](https://quarkus.io/guides/compose-dev-services).
