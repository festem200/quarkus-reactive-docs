...
> **Guia oficial:** <https://quarkus.io/guides/lra>  
> **Fuente:** `docs/src/main/asciidoc/lra.adoc` en [quarkusio/quarkus@3.38.2](https://github.com/quarkusio/quarkus/blob/3.38.2/docs/src/main/asciidoc/lra.adoc)  
...
The model is based on the [Eclipse MicroProfile LRA specification](https://github.com/eclipse/microprofile-lra/blob/master/spec/src/main/asciidoc/microprofile-lra-spec.asciidoc).
The approach is for the developer to annotate a business method with a Java annotation
([`@LRA`](https://download.eclipse.org/microprofile/microprofile-lra-1.0/apidocs/)).
...
[`@Compensate`](https://download.eclipse.org/microprofile/microprofile-lra-1.0/apidocs/)
...
[`@Complete`](https://download.eclipse.org/microprofile/microprofile-lra-1.0/apidocs/)
...
[MicroProfile LRA API v1.0 javadoc](https://download.eclipse.org/microprofile/microprofile-lra-1.0/apidocs/).
...
take a look at one of the [Narayana quickstarts](https://github.com/jbosstm/quickstart/tree/master/rts/lra-examples/lra-coordinator).
...
[Microprofile LRA specification document](https://github.com/eclipse/microprofile-lra/blob/master/spec/src/main/asciidoc/microprofile-lra-spec.asciidoc#java-annotations-for-lras) and in the [Microprofile LRA TCK](https://github.com/eclipse/microprofile-lra/tree/master/tck/src/main/java/org/eclipse/microprofile/lra/tck).
