...
> **Guia oficial:** <https://quarkus.io/guides/smallrye-fault-tolerance>  
> **Fuente:** `docs/src/main/asciidoc/smallrye-fault-tolerance.adoc` en [quarkusio/quarkus@3.38.2](https://github.com/quarkusio/quarkus/blob/3.38.2/docs/src/main/asciidoc/smallrye-fault-tolerance.adoc)  
...
applications, Quarkus provides [SmallRye Fault Tolerance](https://github.com/smallrye/smallrye-fault-tolerance/), an
implementation of the [MicroProfile Fault Tolerance](https://github.com/eclipse/microprofile-fault-tolerance/)
specification.
...
The solution is located in the `microprofile-fault-tolerance-quickstart` [directory](https://github.com/quarkusio/quarkus-quickstarts/tree/main/microprofile-fault-tolerance-quickstart).
...
**❗ IMPORTANT**\
This is an additional feature of [SmallRye Fault Tolerance](https://github.com/smallrye/smallrye-fault-tolerance/) and is not specified by MicroProfile Fault Tolerance.
...
The full set of Quarkus-native configuration properties is detailed in the [Configuration reference](#configuration-reference).
...
Please check the [SmallRye Fault Tolerance documentation](https://smallrye.io/docs/smallrye-fault-tolerance/6.11.1/index.html) to learn about them.
...
The [programmatic API](https://smallrye.io/docs/smallrye-fault-tolerance/6.11.1/reference/programmatic-api.html) is present and integrated with the declarative, annotation-based API.
...
**📌 NOTE**\
La tabla de configuracion generada `quarkus-smallrye-fault-tolerance` se produce al construir la documentacion y no existe en el codigo fuente. Consulta la referencia de configuracion en https://quarkus.io/guides/all-config
...
| --- | --- |
| Quarkus-native config property | `<classname>/<methodname>/<annotation>/<member>` |
| `quarkus.fault-tolerance."<classname>/<methodname>".<annotation>.<member>` | `<classname>/<annotation>/<member>` |
| `quarkus.fault-tolerance."<classname>".<annotation>.<member>` | `<annotation>/<member>` |
| `quarkus.fault-tolerance.global.<annotation>.<member>` | `MP_Fault_Tolerance_NonFallback_Enabled` |
| `quarkus.fault-tolerance.enabled` | `MP_Fault_Tolerance_Metrics_Enabled` |
