...
> **Fuente:** `docs/src/main/asciidoc/smallrye-health.adoc` en [quarkusio/quarkus@3.38.2](https://github.com/quarkusio/quarkus/blob/3.38.2/docs/src/main/asciidoc/smallrye-health.adoc)  
> **Version documentada:** Quarkus 3.38.2 · **Sincronizado:** 2026-08-17 · **Licencia:** Apache-2.0

This guide demonstrates how your Quarkus application can use [SmallRye Health](https://github.com/smallrye/smallrye-health/)
an implementation of the [MicroProfile Health](https://github.com/eclipse/microprofile-health/) specification.
...
[archive](https://github.com/quarkusio/quarkus-quickstarts/archive/main.zip).

The solution is located in the `microprofile-health-quickstart`
[directory](https://github.com/quarkusio/quarkus-quickstarts/tree/main/microprofile-health-quickstart).
...
<dl><dt><strong>📌 NOTE: Management interface</strong></dt><dd>
...
that will validate each datasource: [Datasource Health Check](../03-datos/datasource.md#datasource-health-check).
...
![health-ui-screenshot01](../_assets/health-ui-screenshot01.png)
...
**📌 NOTE**\
La tabla de configuracion generada `quarkus-smallrye-health_quarkus.smallrye-health` se produce al construir la documentacion y no existe en el codigo fuente. Consulta la referencia de configuracion en https://quarkus.io/guides/all-config
