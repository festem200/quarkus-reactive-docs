...
> **Guia oficial:** <https://quarkus.io/guides/config-mappings>  
> **Fuente:** `docs/src/main/asciidoc/config-mappings.adoc` en [quarkusio/quarkus@3.38.2](https://github.com/quarkusio/quarkus/blob/3.38.2/docs/src/main/asciidoc/config-mappings.adoc)  
...
about [registration](https://quarkus.io/guides/config-extending-support#custom-config-source) of a custom `ConfigSource`.
...
The `List` or `Set` mappings can use [indexed properties](../01-fundamentos/config-reference.md#indexed-properties) to map
