...
> **Guia oficial:** <https://quarkus.io/guides/rest-data-panache>  
> **Fuente:** `docs/src/main/asciidoc/rest-data-panache.adoc` en [quarkusio/quarkus@3.38.2](https://github.com/quarkusio/quarkus/blob/3.38.2/docs/src/main/asciidoc/rest-data-panache.adoc)  
...
| --- | --- | --- |
| [quarkus-hibernate-orm-rest-data-panache](#hibernate-orm) | `Stable` | `ORM` |
| [quarkus-hibernate-reactive-rest-data-panache](#hibernate-reactive) | `Experimental` | `Reactive` |
| [quarkus-mongodb-rest-data-panache](#mongodb) | `Experimental` | `ORM` |
...
* Implement the Panache entities and/or repositories as explained in the [Hibernate ORM with Panache](https://quarkus.io/guides/hibernate-orm-panache) guide.
* Define the interfaces for generation as explained in the [Generating resources](#generating-resources) section.

To see the Hibernate ORM REST Data with Panache in action, you can check out the [hibernate-orm-rest-data-panache-quickstart](https://github.com/quarkusio/quarkus-quickstarts/tree/main/hibernate-orm-rest-data-panache-quickstart) quickstart.
...
* Implement the Panache entities and/or repositories as explained in the [Hibernate Reactive with Panache](../03-datos/hibernate-reactive-panache.md) guide.
* Define the interfaces for generation as explained in the [resource generation](#generating-resources) section.
...
* Implement the Panache entities and/or repositories as explained in the [MongoDB with Panache](../03-datos/mongodb-panache.md) guide.
* Define the interfaces for generation as explained in the [resource generation](#generating-resources) section.
...
### Securing endpoints using @PermissionsAllowed annotation

You can also secure your endpoints with the `@PermissionsAllowed` security annotation like in the example below:
...
For more information about how named queries work, go to the [Hibernate ORM](https://quarkus.io/guides/hibernate-orm-panache#named-queries) guide or to the [Hibernate Reactive](../03-datos/hibernate-reactive-panache.md#named-queries) guide.
