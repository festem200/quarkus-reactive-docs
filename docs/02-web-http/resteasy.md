...
> **Guia oficial:** <https://quarkus.io/guides/resteasy>  
> **Fuente:** `docs/src/main/asciidoc/resteasy.adoc` en [quarkusio/quarkus@3.38.2](https://github.com/quarkusio/quarkus/blob/3.38.2/docs/src/main/asciidoc/resteasy.adoc)  
> **Version documentada:** Quarkus 3.38.2 · **Sincronizado:** 2026-08-17 · **Licencia:** Apache-2.0

<dl><dt><strong>⚠️ WARNING</strong></dt><dd>

This guide is about [RESTEasy Classic](https://resteasy.dev), which used to be the default Jakarta REST (formerly known as JAX-RS) implementation until Quarkus 2.8.
...
please see the [introductory REST JSON guide](rest-json.md) or the [Quarkus REST reference documentation](rest.md).
</dd></dl>

**💡 TIP**\
There is another guide if you need a [REST client based on RESTEasy Classic](resteasy-client.md) (including support for JSON).
...
This command generates a new project importing the RESTEasy/Jakarta REST and [Jackson](https://github.com/FasterXML/jackson) extensions,
...
To improve user experience, Quarkus registers the three Jackson [Java 8 modules](https://github.com/FasterXML/jackson-modules-java8), so you do not need to do it manually.
</dd></dl>

Quarkus also supports [JSON-B](https://eclipse-ee4j.github.io/jsonb-api/), so if you prefer JSON-B over Jackson, you can create a project relying on the RESTEasy JSON-B extension instead:
...
This command generates a new project importing the RESTEasy/Jakarta REST and [JSON-B](https://eclipse-ee4j.github.io/jsonb-api/) extensions,
and in particular, adds the following dependency:
...
The `Fruit` objects will be automatically serialized/deserialized by [JSON-B](https://eclipse-ee4j.github.io/jsonb-api/) or [Jackson](https://github.com/FasterXML/jackson),
...
The [HAL](https://www.ietf.org/archive/id/draft-kelly-json-hal-11.html) standard is a simple format to represent web links.
...
| GAV | Usage |
| --- | --- |
| `io.quarkus:quarkus-hal` | [HAL](https://www.ietf.org/archive/id/draft-kelly-json-hal-11.html) |
...
For reactive workloads, please always use [Quarkus REST](rest.md).
</dd></dl>
...
RESTEasy supports multipart via the [RESTEasy Multipart Provider](https://docs.jboss.org/resteasy/docs/4.5.6.Final/userguide/html/Multipart.html).
...
**📌 NOTE**\
La tabla de configuracion generada `quarkus-resteasy-multipart` se produce al construir la documentacion y no existe en el codigo fuente. Consulta la referencia de configuracion en https://quarkus.io/guides/all-config
...
[`HttpRequest`](https://docs.jboss.org/resteasy/docs/4.5.6.Final/javadocs/org/jboss/resteasy/spi/HttpRequest.html), which has the methods
[`getRemoteAddress()`](https://docs.jboss.org/resteasy/docs/4.5.6.Final/javadocs/org/jboss/resteasy/spi/HttpRequest.html#getRemoteAddress--)
and [`getRemoteHost()`](https://docs.jboss.org/resteasy/docs/4.5.6.Final/javadocs/org/jboss/resteasy/spi/HttpRequest.html#getRemoteHost--)
to solve this problem.

## RESTEasy and REST Client interactions

In Quarkus, the RESTEasy extension and [the REST Client extension](resteasy-client.md) share the same infrastructure.
