...
> **Guia oficial:** <https://quarkus.io/guides/rest>  
> **Fuente:** `docs/src/main/asciidoc/rest.adoc` en [quarkusio/quarkus@3.38.2](https://github.com/quarkusio/quarkus/blob/3.38.2/docs/src/main/asciidoc/rest.adoc)  
...
For a more lightweight introduction, please refer to the [Writing JSON REST services guides](rest-json.md).
</dd></dl>

## What is Quarkus REST?

Quarkus REST is a new [Jakarta REST (formerly known as JAX-RS)](https://jakarta.ee/specifications/restful-ws/3.1/jakarta-restful-ws-spec-3.1.html)
implementation written from the ground up to work on our
common [Vert.x](https://vertx.io/) layer and is thus fully reactive, while also being very tightly integrated with
...
Used to identify the location of REST resources ([specification](https://tools.ietf.org/html/rfc7230#section-2.7))
* **Resource**\
...
* **HTTP**\
Underlying wire protocol for routing REST calls (see [HTTP specifications](https://tools.ietf.org/html/rfc7230))
* **HTTP request**\
...
Any class annotated with a [`@Path`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/Path.html) annotation can have its methods exposed as REST endpoints,
provided they have an HTTP method annotation (see below).

That [`@Path`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/Path.html) annotation defines the URI prefix under which those methods will be exposed. It can
be empty, or contain a prefix such as `rest` or `rest/V1`.

Each exposed endpoint method can in turn have another [`@Path`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/Path.html) annotation which adds to its containing
...
See [URI parameters](#a-namedeclaring-uri-parametersa-declaring-uri-parameters) for more information about URI mapping.
...
be accessible at `/api/rest/`. You can also set the [`quarkus.rest.path`](#quarkus-rest-common_quarkus-rest-path) build time property to set the root path if you
...
| Annotation | Usage |
| --- | --- |
| [`@GET`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/GET.html) | Obtain a resource representation, should not modify state, [idempotent](https://tools.ietf.org/html/rfc7231#section-4.2.2) ([HTTP docs](https://tools.ietf.org/html/rfc7231#section-4.3.1)) |
| [`@HEAD`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/HEAD.html) | Obtain metadata about a resource, similar to `GET` with no body ([HTTP docs](https://tools.ietf.org/html/rfc7231#section-4.3.2)) |
| [`@POST`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/POST.html) | Create a resource and obtain a link to it ([HTTP docs](https://tools.ietf.org/html/rfc7231#section-4.3.3)) |
| [`@PUT`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/PUT.html) | Replace a resource or create one, should be [idempotent](https://tools.ietf.org/html/rfc7231#section-4.2.2) ([HTTP docs](https://tools.ietf.org/html/rfc7231#section-4.3.4)) |
| [`@DELETE`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/DELETE.html) | Delete an existing resource, [idempotent](https://tools.ietf.org/html/rfc7231#section-4.2.2)  ([HTTP docs](https://tools.ietf.org/html/rfc7231#section-4.3.5)) |
| [`@OPTIONS`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/OPTIONS.html) | Obtain information about a resource, [idempotent](https://tools.ietf.org/html/rfc7231#section-4.2.2) ([HTTP docs](https://tools.ietf.org/html/rfc7231#section-4.3.7)) |
| [`@PATCH`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/PATCH.html) | Update a resource, or create one, not [idempotent](https://tools.ietf.org/html/rfc7231#section-4.2.2) ([HTTP docs](https://tools.ietf.org/html/rfc5789#section-2)) |

You can also declare other HTTP methods by declaring them as an annotation with the
[`@HttpMethod`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/HttpMethod.html) annotation:
...
the HTTP [`Content-Type`](https://tools.ietf.org/html/rfc7231#section-3.1.1.5) header, which in turn contains
[MIME (Media Type)](https://tools.ietf.org/html/rfc7231#section-3.1.1.1) values, such as the following:

* `text/plain` which is the default for any endpoint returning a `String`.
* `text/html` for HTML (such as with [Qute templating](qute.md))
* `application/json` for a [JSON REST endpoint](#json)
* `text/*` which is a sub-type wildcard for any text media type
* `\*/*` which is a wildcard for any media type

You may annotate your endpoint class with the [`@Produces`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/Produces.html)
or [`@Consumes`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/Consumes.html) annotations, which
...
Any method may also be annotated with the [`@Produces`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/Produces.html)
or [`@Consumes`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/Consumes.html) annotations, in which
case they override any eventual class annotation.

The [`MediaType`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/core/MediaType.html) class has many constants you
can use to point to specific pre-defined media types.

See the [Negotiation](#negotiation) section for more information.

### Accessing request parameters

**📌 NOTE**\
don’t forget to configure your compiler to generate parameter name information with `-parameters` (javac)
or `<parameters>` or `<maven.compiler.parameters>` ([Maven](https://maven.apache.org/plugins/maven-compiler-plugin/compile-mojo.html#parameters)).
...
| --- | --- | --- |
| <a name="path-parameter"></a>Path parameter | [`@RestPath`](https://javadoc.io/doc/io.quarkus.resteasy.reactive/resteasy-reactive-common/3.38.2/org/jboss/resteasy/reactive/RestPath.html) (or nothing) | URI template parameter (simplified version of the [URI Template specification](https://tools.ietf.org/html/rfc6570)), see [URI parameters](#a-namedeclaring-uri-parametersa-declaring-uri-parameters) for more information. |
| Query parameter | [`@RestQuery`](https://javadoc.io/doc/io.quarkus.resteasy.reactive/resteasy-reactive-common/3.38.2/org/jboss/resteasy/reactive/RestQuery.html) | The value of a [URI query parameter](https://tools.ietf.org/html/rfc3986#section-3.4) |
| Header | [`@RestHeader`](https://javadoc.io/doc/io.quarkus.resteasy.reactive/resteasy-reactive-common/3.38.2/org/jboss/resteasy/reactive/RestHeader.html) | The value of an [HTTP header](https://tools.ietf.org/html/rfc7230#section-3.2) |
| Cookie | [`@RestCookie`](https://javadoc.io/doc/io.quarkus.resteasy.reactive/resteasy-reactive-common/3.38.2/org/jboss/resteasy/reactive/RestCookie.html) | The value of an [HTTP cookie](https://tools.ietf.org/html/rfc6265#section-4.2) |
| Form parameter | [`@RestForm`](https://javadoc.io/doc/io.quarkus.resteasy.reactive/resteasy-reactive-common/3.38.2/org/jboss/resteasy/reactive/RestForm.html) | The value of an [HTTP URL-encoded FORM](https://developer.mozilla.org/en-US/docs/Web/HTTP/Methods/POST) |
| Matrix parameter | [`@RestMatrix`](https://javadoc.io/doc/io.quarkus.resteasy.reactive/resteasy-reactive-common/3.38.2/org/jboss/resteasy/reactive/RestMatrix.html) | The value of an [URI path segment parameter](https://tools.ietf.org/html/rfc3986#section-3.3) |
...
**📌 NOTE**\
The [`@RestPath`](https://javadoc.io/doc/io.quarkus.resteasy.reactive/resteasy-reactive-common/3.38.2/org/jboss/resteasy/reactive/RestPath.html)
annotation is optional: any parameter whose name matches an existing URI
template variable will be automatically assumed to have [`@RestPath`](https://javadoc.io/doc/io.quarkus.resteasy.reactive/resteasy-reactive-common/3.38.2/org/jboss/resteasy/reactive/RestPath.html).

You can also use any of the Jakarta REST annotations [`@PathParam`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/PathParam.html),
[`@QueryParam`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/QueryParam.html),
[`@HeaderParam`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/HeaderParam.html),
[`@CookieParam`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/CookieParam.html),
[`@FormParam`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/FormParam.html) or
[`@MatrixParam`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/MatrixParam.html) for this,
but they require you to specify the parameter name.

See [Parameter mapping](#parameter-mapping) for more advanced use-cases.
...
### <a name="declaring-uri-parameters"></a> Declaring URI parameters
...
[URI template parameter](#path-parameter) or a [context object](#context-objects).], after it has been mapped from
...
| Type | Usage |
| --- | --- |
| [`File`](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/io/File.html) | The entire request body in a temporary file |
| `byte[]` | The entire request body, not decoded |
| `char[]` | The entire request body, decoded |
| [`String`](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) | The entire request body, decoded |
| [`InputStream`](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/io/InputStream.html) | The request body in a blocking stream |
| [`Reader`](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/io/Reader.html) | The request body in a blocking stream |
| All Java primitives and their wrapper classes | Java primitive types |
| [`BigDecimal`](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/math/BigDecimal.html), [`BigInteger`](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/math/BigInteger.html) | Large integers and decimals. |
| [`JsonArray`](https://javadoc.io/doc/jakarta.json/jakarta.json-api/2.1.2/jakarta.json/jakarta/json/JsonArray.html), [`JsonObject`](https://javadoc.io/doc/jakarta.json/jakarta.json-api/2.1.2/jakarta.json/jakarta/json/JsonObject.html), [`JsonStructure`](https://javadoc.io/doc/jakarta.json/jakarta.json-api/2.1.2/jakarta.json/jakarta/json/JsonStructure.html), [`JsonValue`](https://javadoc.io/doc/jakarta.json/jakarta.json-api/2.1.2/jakarta.json/jakarta/json/JsonValue.html) | JSON value types |
| [`Buffer`](https://javadoc.io/static/io.vertx/vertx-core/4.4.6/io/vertx/core/buffer/Buffer.html) | Vert.x Buffer |
| any other type | Will be [mapped from JSON to that type](#json) |

**📌 NOTE**\
You can add support for more [body parameter types](#readers-writers).

### Handling Multipart Form data

To handle HTTP requests that have `multipart/form-data` as their content type, you can use the regular
[`@RestForm`](https://javadoc.io/doc/io.quarkus.resteasy.reactive/resteasy-reactive-common/3.38.2/org/jboss/resteasy/reactive/RestForm.html) annotation, but we have special types
...
[`@RestForm`](https://javadoc.io/doc/io.quarkus.resteasy.reactive/resteasy-reactive-common/3.38.2/org/jboss/resteasy/reactive/RestForm.html) does not define a value, the field name is used),
while the `file` parameter will contain data about the uploaded file in the `image` part of HTTP request, and
the `person` parameter will read the `Person` entity using the `JSON` [body reader](#json).
...
**📌 NOTE**\
[`FileUpload`](https://javadoc.io/doc/io.quarkus.resteasy.reactive/resteasy-reactive-common/3.38.2/org/jboss/resteasy/reactive/multipart/FileUpload.html)
...
**📌 NOTE**\
[`@PartType`](https://javadoc.io/doc/io.quarkus.resteasy.reactive/resteasy-reactive-common/3.38.2/org/jboss/resteasy/reactive/PartType.html) is used to aid
in deserialization of the corresponding part of the request into the desired Java type. It is only required if
you need to use a [special body parameter type](#readers-writers) for that particular parameter.

**📌 NOTE**\
Just like for any other request parameter type, you can also group them into a [container class](#parameter-grouping).
...
As part of reading the multipart body, Quarkus REST invokes the proper MessageBodyReader[`MessageBodyReader`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/ext/MessageBodyReader.html) for each part of the request.
...
If this exception is not handled by the application as mentioned in [Exception mapping](#exception-mapping), an HTTP 400 response is returned by default.
...
response (see the [Negotiation](#negotiation) section for more advanced information).

You can return any of the pre-defined types that you can read from the [HTTP response](#resource-types),
and any other type will be mapped [from that type to JSON](#json).
...
| Type | Usage |
| --- | --- |
| [`Path`](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/nio/file/Path.html) | The contents of the file specified by the given path |
| [`PathPart`](https://javadoc.io/doc/io.quarkus.resteasy.reactive/resteasy-reactive-common/3.38.2/org/jboss/resteasy/reactive/PathPart.html) | The partial contents of the file specified by the given path |
| [`FilePart`](https://javadoc.io/doc/io.quarkus.resteasy.reactive/resteasy-reactive-common/3.38.2/org/jboss/resteasy/reactive/FilePart.html) | The partial contents of a file |
| [`AsyncFile`](https://javadoc.io/static/io.vertx/vertx-core/4.4.6/io/vertx/core/file/AsyncFile.html) | Vert.x AsyncFile, which can be in full, or partial |

Alternately, you can also return a [reactive type](#reactive) such as [`Uni`](https://javadoc.io/doc/io.smallrye.reactive/mutiny/2.1.0/io.smallrye.mutiny/io/smallrye/mutiny/Uni.html),
[`Multi`](https://javadoc.io/doc/io.smallrye.reactive/mutiny/2.1.0/io.smallrye.mutiny/io/smallrye/mutiny/Multi.html) or
...
[`Uni`](https://javadoc.io/doc/io.smallrye.reactive/mutiny/2.1.0/io.smallrye.mutiny/io/smallrye/mutiny/Uni.html) type (from [Mutiny](https://smallrye.io/smallrye-mutiny/)), in which
case the current HTTP request will be automatically suspended after your method, until
the returned [`Uni`](https://javadoc.io/doc/io.smallrye.reactive/mutiny/2.1.0/io.smallrye.mutiny/io/smallrye/mutiny/Uni.html) instance resolves to a value,
...
See [Execution Model documentation](#execution-model) for more information.

The [`CompletionStage`](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/concurrent/CompletionStage.html) return
...
**📌 NOTE**\
When a client drops the connection, `ContainerResponseFilter` implementations are normally skipped.
...
[`Multi`](https://javadoc.io/doc/io.smallrye.reactive/mutiny/2.1.0/io.smallrye.mutiny/io/smallrye/mutiny/Multi.html) type (from [Mutiny](https://smallrye.io/smallrye-mutiny/)).
This is especially useful for streaming text or binary data.

This example, using [Reactive Messaging HTTP](https://github.com/quarkiverse/quarkus-reactive-messaging-http) shows how to stream
text data:
...
[`@Produces(MediaType.SERVER_SENT_EVENTS)`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/Produces.html)
and specifying that each element should be [serialised to JSON](#json) with
...
public class Endpoint {
    ...
    public Multi<OutboundSseEvent> stream() {
        return books.map(book -> sse.newEventBuilder() ②
            .name("book")  ③
            .data(book.title) ④
            .build());
    }
...
Quarkus REST provides the [`@Cache`](https://javadoc.io/doc/io.quarkus.resteasy.reactive/resteasy-reactive-common/3.38.2/org/jboss/resteasy/reactive/Cache.html)
and [`@NoCache`](https://javadoc.io/doc/io.quarkus.resteasy.reactive/resteasy-reactive-common/3.38.2/org/jboss/resteasy/reactive/NoCache.html) annotations to facilitate
...
While [`@Cache`](https://javadoc.io/doc/io.quarkus.resteasy.reactive/resteasy-reactive-common/3.38.2/org/jboss/resteasy/reactive/Cache.html)
builds a complex `Cache-Control` header, [`@NoCache`](https://javadoc.io/doc/io.quarkus.resteasy.reactive/resteasy-reactive-common/3.38.2/org/jboss/resteasy/reactive/NoCache.html)
is a simplified notation to say that you don’t want anything cached; i.e. `Cache-Control: nocache`.

**📌 NOTE**\
More information on the `Cache-Control` header and be found in [RFC 7234](https://datatracker.ietf.org/doc/html/rfc7234)
...
| Type | Usage |
| --- | --- |
| [`HttpHeaders`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/core/HttpHeaders.html) | All the request headers |
| [`ResourceInfo`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/container/ResourceInfo.html) | Information about the current endpoint method and class (requires reflection) |
| [`SecurityContext`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/core/SecurityContext.html) | Access to the current user and roles |
| [`SimpleResourceInfo`](https://javadoc.io/doc/io.quarkus.resteasy.reactive/resteasy-reactive/3.38.2/org/jboss/resteasy/reactive/server/SimpleResourceInfo.html) | Information about the current endpoint method and class (no reflection required) |
| [`UriInfo`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/core/UriInfo.html) | Provides information about the current endpoint and application URI |
| [`Application`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/core/Application.html) | Advanced: Current Jakarta REST application class |
| [`Configuration`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/core/Configuration.html) | Advanced: Configuration about the deployed Jakarta REST application |
| [`Providers`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/ext/Providers.html) | Advanced: Runtime access to Jakarta REST providers |
| [`Request`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/core/Request.html) | Advanced: Access to the current HTTP method and [Preconditions](#preconditions) |
| [`ResourceContext`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/core/ResourceContext.html) | Advanced: access to instances of endpoints |
| [`ServerRequestContext`](https://javadoc.io/doc/io.quarkus.resteasy.reactive/resteasy-reactive/3.38.2/org/jboss/resteasy/reactive/server/spi/ServerRequestContext.html) | Advanced: Quarkus REST access to the current request/response |
| [`Sse`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/sse/Sse.html) | Advanced: Complex SSE use-cases |
| [`HttpServerRequest`](https://javadoc.io/static/io.vertx/vertx-core/4.4.6/io/vertx/core/http/HttpServerRequest.html) | Advanced: Vert.x HTTP Request |
| [`HttpServerResponse`](https://javadoc.io/static/io.vertx/vertx-core/4.4.6/io/vertx/core/http/HttpServerResponse.html) | Advanced: Vert.x HTTP Response |
...
[`@Inject`](https://javadoc.io/static/jakarta.inject/jakarta.inject-api/2.0.1/jakarta.inject/jakarta/inject/Inject.html) on fields of the same
type:
...
| GAV | Usage |
| --- | --- |
| `io.quarkus:quarkus-rest-jackson` | [Jackson support](https://github.com/FasterXML/jackson) |
| `io.quarkus:quarkus-rest-jsonb` | [JSON-B support](https://github.com/jakartaee/jsonb-api/) |
...
```
1. The `io.quarkus.resteasy.reactive.jackson.SecureField.rolesAllowed` property supports [property expressions](../01-fundamentos/config-reference.md#property-expressions)
exactly in the same fashion the `jakarta.annotation.security.RolesAllowed` annotation does. For more information, please
refer to the [Standard security annotations](https://quarkus.io/guides/security-authorize-web-endpoints-reference#standard-security-annotations)
...
Assuming security has been set up for the application (see our [guide](https://quarkus.io/guides/security-overview) for more details), when a user with the `admin` role
...
However, Quarkus follows a build-time optimization philosophy.
...
To enable this feature, set the [`quarkus.rest.jackson.optimization.enable-reflection-free-serializers`](#quarkus-rest-jackson_quarkus-rest-jackson-optimization-enable-reflection-free-serializers) configuration property to `true`:

`quarkus.rest.jackson.optimization.enable-reflection-free-serializers=true`.

Setting this property applies reflection-free optimization to deserialization and serialization.

When enabled, Quarkus generates `StdSerializer` and `StdDeserializer` implementations at build time for each class requiring JSON conversion. The application then processes objects returned by REST endpoints using these generated serializers and deserializers, eliminating reliance on reflection and improving performance.
...
| GAV | Usage |
| --- | --- |
| `io.quarkus:quarkus-rest-jaxb` | [XML support](https://javaee.github.io/jaxb-v2/) |
...
| GAV | Usage |
| --- | --- |
| `io.quarkus:quarkus-rest-links` | [Web Links support](https://www.w3.org/wiki/LinkHeader) |
...
The [HAL](https://datatracker.ietf.org/doc/html/draft-kelly-json-hal-08) standard is a simple format to represent web links.
...
| GAV | Usage |
| --- | --- |
| `io.quarkus:quarkus-hal` | [HAL](https://datatracker.ietf.org/doc/html/draft-kelly-json-hal-08) |
...
For more information about the CORS filters and their usage, see the [CORS filter](security-cors.md#cors-filter) section of the Quarkus "Cross-origin resource sharing" guide.
...
[`@Blocking`](https://javadoc.io/doc/io.smallrye.common/smallrye-common-annotation/1.5.0/io/smallrye/common/annotation/Blocking.html)
and
[`@NonBlocking`](https://javadoc.io/doc/io.smallrye.common/smallrye-common-annotation/1.5.0/io/smallrye/common/annotation/NonBlocking.html)
...
way, using [Mutiny](https://smallrye.io/smallrye-mutiny/), [Hibernate Reactive](https://hibernate.org/reactive/)
or any of the [Quarkus Reactive extensions](../01-fundamentos/quarkus-reactive-architecture.md#quarkus-extensions-enabling-reactive) for example:
...
framework using [`WebApplicationException`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/WebApplicationException.html) or any of its subtypes:
...
[`@ServerExceptionMapper`](https://javadoc.io/doc/io.quarkus.resteasy.reactive/resteasy-reactive/3.38.2/org/jboss/resteasy/reactive/server/ServerExceptionMapper.html)
annotation on a method, with one parameter of the exception type you want to handle, and turning
that exception into a [`RestResponse`](https://javadoc.io/doc/io.quarkus.resteasy.reactive/resteasy-reactive-common/3.38.2/org/jboss/resteasy/reactive/RestResponse.html) (or a
[`Uni<RestResponse<?>>`](https://javadoc.io/doc/io.smallrye.reactive/mutiny/2.1.0/io.smallrye.mutiny/io/smallrye/mutiny/Uni.html)):
...
You can also declare [exception mappers in the Jakarta REST way](https://jakarta.ee/specifications/restful-ws/3.1/jakarta-restful-ws-spec-3.1.html#exceptionmapper).
</dd></dl>
...
| Type | Usage |
| --- | --- |
| An exception type | Defines the exception type you want to handle |
| Any of the [Context objects](#context-objects) |  |
| [`ContainerRequestContext`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/container/ContainerRequestContext.html) | A context object to access the current request |
...
| Type | Usage |
| --- | --- |
| [`RestResponse`](https://javadoc.io/doc/io.quarkus.resteasy.reactive/resteasy-reactive-common/3.38.2/org/jboss/resteasy/reactive/RestResponse.html) or [`Response`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/core/Response.html) | The response to send to the client when the exception occurs |
| [`Uni<RestResponse>`](https://javadoc.io/doc/io.smallrye.reactive/mutiny/2.1.0/io.smallrye.mutiny/io/smallrye/mutiny/Uni.html) or [`Uni<Response>`](https://javadoc.io/doc/io.smallrye.reactive/mutiny/2.1.0/io.smallrye.mutiny/io/smallrye/mutiny/Uni.html) | An asynchronous response to send to the client when the exception occurs |
...
[`@ServerRequestFilter`](https://javadoc.io/doc/io.quarkus.resteasy.reactive/resteasy-reactive/3.38.2/org/jboss/resteasy/reactive/server/ServerRequestFilter.html)
annotation:
...
[`@ServerResponseFilter`](https://javadoc.io/doc/io.quarkus.resteasy.reactive/resteasy-reactive/3.38.2/org/jboss/resteasy/reactive/server/ServerResponseFilter.html)
annotation:
...
Such a response filter will also be called for [handled](#exception-mapping) exceptions.
...
| Any of the [Context objects](#context-objects) |  |
| [`ContainerRequestContext`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/container/ContainerRequestContext.html) | A context object to access the current request |
| [`ContainerResponseContext`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/container/ContainerResponseContext.html) | A context object to access the current response |
| [`Throwable`](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html) | Any thrown and [handled](#exception-mapping) exception, or `null` (only for response filters). |
...
| Type | Usage |
| --- | --- |
| [`RestResponse<?>`](https://javadoc.io/doc/io.quarkus.resteasy.reactive/resteasy-reactive-common/3.38.2/org/jboss/resteasy/reactive/RestResponse.html) or [`Response`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/core/Response.html) | The response to send to the client instead of continuing the filter chain, or `null` if the filter chain should proceed |
| [`Optional<RestResponse<?>>`](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Optional.html) or [`Optional<Response>`](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Optional.html) | An optional response to send to the client instead of continuing the filter chain, or an empty value if the filter chain should proceed |
| [`Uni<RestResponse<?>>`](https://javadoc.io/doc/io.smallrye.reactive/mutiny/2.1.0/io.smallrye.mutiny/io/smallrye/mutiny/Uni.html) or [`Uni<Response>`](https://javadoc.io/doc/io.smallrye.reactive/mutiny/2.1.0/io.smallrye.mutiny/io/smallrye/mutiny/Uni.html) | An asynchronous response to send to the client instead of continuing the filter chain, or `null` if the filter chain should proceed |

**📌 NOTE**\
You can restrict the Resource methods for which a filter runs, by using [`@NameBinding`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/NameBinding.html) meta-annotations.

#### The Jakarta REST way

You can also [declare request and response filters in the Jakarta REST way](https://jakarta.ee/specifications/restful-ws/3.1/jakarta-restful-ws-spec-3.1.html#filters).
...
A `ContainerResponseFilter` will also be called for [handled](#exception-mapping) exceptions.
</dd></dl>
...
[`RestResponse<?>`](https://javadoc.io/doc/io.quarkus.resteasy.reactive/resteasy-reactive-common/3.38.2/org/jboss/resteasy/reactive/RestResponse.html)
or [`Response`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/core/Response.html) with
...
This is done via a pluggable system of [`MessageBodyReader`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/ext/MessageBodyReader.html)
and [`MessageBodyWriter`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/ext/MessageBodyWriter.html) interfaces,
...
with [`@Provider`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/ext/Provider.html):
...
[`ServerMessageBodyWriter`](https://javadoc.io/doc/io.quarkus.resteasy.reactive/resteasy-reactive/3.38.2/org/jboss/resteasy/reactive/server/spi/ServerMessageBodyWriter.html)
instead of [`MessageBodyWriter`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/ext/MessageBodyWriter.html)
...
[`Consumes`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/Consumes.html)/[`Produces`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/Produces.html) annotations
...
extending the [`ReaderInterceptor`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/ext/ReaderInterceptor.html) or
[`WriterInterceptor`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/ext/WriterInterceptor.html) on a class annotated with
[`@Provider`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/ext/Provider.html).
...
In Quarkus, the Quarkus REST extension and [the REST Client extension](rest-client.md) share the same infrastructure.
...
All [Request Parameters](#request-parameters) can be declared as [`String`](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html),
but also as any of the following types:

1. Types for which a [`ParamConverter`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/ext/ParamConverter.html) is available via a registered
[`ParamConverterProvider`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/ext/ParamConverterProvider.html).
2. Primitive types.
3. Types that have a constructor that accepts a single [`String`](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) argument.
4. Types that have a static method named `valueOf` or `fromString` with a single [`String`](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) argument
...
5. [`List<T>`](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html), [`Set<T>`](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Set.html), or
[`SortedSet<T>`](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/SortedSet.html), where `T` satisfies 1, 3 or 4 above.
...
[HTTP allows requests to be conditional](https://tools.ietf.org/html/rfc7232), based on a number of
conditions, such as:
...
[`Request`](https://javadoc.io/doc/jakarta.ws.rs/jakarta.ws.rs-api/3.1.0/jakarta.ws.rs/jakarta/ws/rs/core/Request.html) context object:
...
One of the main ideas of REST ([and HTTP](https://tools.ietf.org/html/rfc7231#section-3.4)) is that
...
[`Accept`](https://tools.ietf.org/html/rfc7231#section-5.3.2) header, in the case of JSON:
...
See the [REST Client Guide](rest-client.md) for more information about the REST client.

## Quarkus REST Configuration Reference

**📌 NOTE**\
La tabla de configuracion generada `quarkus-rest-common_quarkus.rest` se produce al construir la documentacion y no existe en el codigo fuente. Consulta la referencia de configuracion en https://quarkus.io/guides/all-config

**📌 NOTE**\
La tabla de configuracion generada `quarkus-rest-jackson` se produce al construir la documentacion y no existe en el codigo fuente. Consulta la referencia de configuracion en https://quarkus.io/guides/all-config
