...
> **Guia oficial:** <https://quarkus.io/guides/resteasy-client-multipart>  
> **Fuente:** `docs/src/main/asciidoc/resteasy-client-multipart.adoc` en [quarkusio/quarkus@3.38.2](https://github.com/quarkusio/quarkus/blob/3.38.2/docs/src/main/asciidoc/resteasy-client-multipart.adoc)  
> **Version documentada:** Quarkus 3.38.2 · **Sincronizado:** 2026-08-17 · **Licencia:** Apache-2.0

<dl><dt><strong>⚠️ WARNING</strong></dt><dd>

This guide is about the multipart support of the REST Client compatible with [RESTEasy Classic](https://resteasy.dev) which used to be the default Jakarta REST (formerly known as JAX-RS) implementation until Quarkus 2.8.
...
The solution is located in the `resteasy-client-multipart-quickstart` [directory](https://github.com/quarkusio/quarkus-quickstarts/tree/main/resteasy-client-multipart-quickstart).
...
The code above uses [REST Assured](https://rest-assured.io/) to assert that the returned content from the echo service contains multipart elements
...
* [RESTEasy Multipart Provider](https://docs.jboss.org/resteasy/docs/4.5.6.Final/userguide/html/Multipart.html)
* [MicroProfile Rest Client specification](https://download.eclipse.org/microprofile/microprofile-rest-client-1.4.1/microprofile-rest-client-1.4.1.html)
