...
> **Guia oficial:** <https://quarkus.io/guides/validation>  
> **Fuente:** `docs/src/main/asciidoc/validation.adoc` en [quarkusio/quarkus@3.38.2](https://github.com/quarkusio/quarkus/blob/3.38.2/docs/src/main/asciidoc/validation.adoc)  
...
![validation-guide-architecture](../_assets/validation-guide-architecture.png)
...
The solution is located in the `validation-quickstart` [directory](https://github.com/quarkusio/quarkus-quickstarts/tree/main/validation-quickstart).
...
* If using Powershell, wrap `-D` parameters in double quotes e.g. `"-DprojectArtifactId=validation-quickstart"`
...
In the `src/main/resources/META-INF/resources` directory, replace the `index.html` file with the content from this [index.html](https://github.com/quarkusio/quarkus-quickstarts/blob/main/validation-quickstart/src/main/resources/META-INF/resources/index.html) file in it.
...
![validation-guide-screenshot](../_assets/validation-guide-screenshot.png)
...
**📌 NOTE**\
La tabla de configuracion generada `quarkus-hibernate-validator` se produce al construir la documentacion y no existe en el codigo fuente. Consulta la referencia de configuracion en https://quarkus.io/guides/all-config
