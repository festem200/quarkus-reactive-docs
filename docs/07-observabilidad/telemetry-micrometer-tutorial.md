...
> **Guia oficial:** <https://quarkus.io/guides/telemetry-micrometer-tutorial>  
> **Fuente:** `docs/src/main/asciidoc/telemetry-micrometer-tutorial.adoc` en [quarkusio/quarkus@3.38.2](https://github.com/quarkusio/quarkus/blob/3.38.2/docs/src/main/asciidoc/telemetry-micrometer-tutorial.adoc)  
...
* Download an [archive](https://github.com/quarkusio/quarkus-quickstarts/archive/main.zip).

The solution is located in the `micrometer-quickstart` [directory](https://github.com/quarkusio/quarkus-quickstarts/tree/main/micrometer-quickstart).
...
NOTE: La tabla de configuracion generada `telemetry-micrometer-tutorial-example-resource` se produce al construir la documentacion y no existe en el codigo fuente. Consulta la referencia de configuracion en https://quarkus.io/guides/all-config
