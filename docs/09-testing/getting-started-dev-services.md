...
> **Guia oficial:** <https://quarkus.io/guides/getting-started-dev-services>  
> **Fuente:** `docs/src/main/asciidoc/getting-started-dev-services.adoc` en [quarkusio/quarkus@3.38.2](https://github.com/quarkusio/quarkus/blob/3.38.2/docs/src/main/asciidoc/getting-started-dev-services.adoc)  
...
This tutorial builds on what you learned writing [your first Quarkus application](../10-extras/getting-started.md).
You will not need the code from that application, but make sure you understand the concepts.

## Solution

We recommend that you follow the instructions from [Bootstrapping the project](#bootstrapping-the-project) onwards to create the application step by step.

However, you can go right to the completed example.

Download an [archive](https://github.com/quarkusio/quarkus-quickstarts/archive/main.zip) or clone the git repository:

```bash
git clone https://github.com/quarkusio/quarkus-quickstarts.git
```

The solution is located in the `getting-started-dev-services` [directory](https://github.com/quarkusio/quarkus-quickstarts/tree/main/getting-started-dev-services).
...
* If using Powershell, wrap `-D` parameters in double quotes e.g. `"-DprojectArtifactId=getting-started-dev-services"`

For an explanation of what’s in the generated application, see the [First application guide](../10-extras/getting-started.md).
...
The entity makes use of [Panache](https://quarkus.io/guides/hibernate-orm-panache), a layer on top of Hibernate ORM.
...
<dl><dt><strong>📌 NOTE: GETs should not change application state.</strong></dt><dd>
...
<dl><dt><strong>❗ IMPORTANT: a container runtime is required.</strong></dt><dd>
...
The database is being managed using [Dev Services](dev-services.md).
...
```bash
ff88dcedd899  docker.io/library/postgres:18  postgres -c fsync...  20 minutes ago  Up 20 minutes  0.0.0.0:34789->5432/tcp  nostalgic_bassi
```
...
See the [Hibernate configuration reference](https://quarkus.io/guides/hibernate-orm#quarkus-hibernate-orm_quarkus-hibernate-orm-schema-management-strategy) for more details.
...
only applies to the [prod profile](../01-fundamentos/config-reference.md#profiles)
