...
> **Guia oficial:** <https://quarkus.io/guides/grpc-generation-reference>  
> **Fuente:** `docs/src/main/asciidoc/grpc-generation-reference.adoc` en [quarkusio/quarkus@3.38.2](https://github.com/quarkusio/quarkus/blob/3.38.2/docs/src/main/asciidoc/grpc-generation-reference.adoc)  
> **Version documentada:** Quarkus 3.38.2 · **Sincronizado:** 2026-08-17 · **Licencia:** Apache-2.0

This reference guide explains how to configure gRPC code generation. It is recommended to read the [official gRPC guide](grpc.md) first.
...
Protocol Buffers do not contain descriptions of their own types. Thus, given only a raw message without the corresponding .proto file defining its type, it is difficult to extract any useful data. However, the contents of a .proto file can itself be [represented using protocol buffers](https://protobuf.dev/programming-guides/techniques/#self-description).
...
`protoc` also supports [generating Kotlin code](https://protobuf.dev/reference/kotlin/kotlin-generated/) in addition to the generated Java code.
...
More information on this topic can be found in the [Bean Discovery](../01-fundamentos/cdi-reference.md#bean_discovery) section of the CDI guide.
...
Refer to the [dedicated section](#proto-files-from-dependencies) for more information.
...
**⚠️ WARNING**\
When using [AArch64](https://en.wikipedia.org/wiki/AArch64) on macOS be aware of this [issue](https://github.com/grpc/grpc-java/issues/11844): meaning that the macOS [x86_64](https://en.wikipedia.org/wiki/X86) protoc and macOS aarch_64 protoc are the `same` - both are macOS x86_64. So you need to enable [Rosetta](https://en.wikipedia.org/wiki/Rosetta_(software)) (`softwareupdate --install-rosetta`) on your ARM based macOS if you want to generate protobuf classes.
