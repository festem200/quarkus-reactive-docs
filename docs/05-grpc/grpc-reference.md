...
> **Guia oficial:** <https://quarkus.io/guides/grpc-reference>  
> **Fuente:** `docs/src/main/asciidoc/grpc-reference.adoc` en [quarkusio/quarkus@3.38.2](https://github.com/quarkusio/quarkus/blob/3.38.2/docs/src/main/asciidoc/grpc-reference.adoc)  
...
The previous configuration uses the [centralized TLS configuration](../08-rendimiento-nativo/tls-registry-reference.md).
