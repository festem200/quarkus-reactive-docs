...
> **Guia oficial:** <https://quarkus.io/guides/infinispan-client-reference>  
> **Fuente:** `docs/src/main/asciidoc/infinispan-client-reference.adoc` en [quarkusio/quarkus@3.38.2](https://github.com/quarkusio/quarkus/blob/3.38.2/docs/src/main/asciidoc/infinispan-client-reference.adoc)  
...
1. Following the [Get Started Tutorial](https://infinispan.org/get-started/) (5 minutes).
2. Running the **remote cache** [simple code tutorials](https://infinispan.org/tutorials/).

Learn more in the [Infinispan documentation](https://infinispan.org/documentation).
...
If you are running a Docker instance, you can use [Infinispan Dev Services](https://quarkus.io/guides/infinispan-dev-services)
and connect without configuration.

If you want to run the server yourself using Docker, check out the 5-minute [Getting stated with Infinispan](https://infinispan.org/get-started/)
tutorial to run Infinispan Server

You can also [download](https://infinispan.org/download/) 16.0.14 Server bare metal distribution and run the following command
...
In Kubernetes, we recommend the [Infinispan Operator](https://infinispan.org/docs/infinispan-operator/main/operator.html).
Additionally, grab a look to
the [Cross Site Replication](https://infinispan.org/tutorials/simple/simple_tutorials.html#cross-site-replication_remote-cache-tutorials)
...
```properties
quarkus.infinispan-client.uri=hotrod://admin:password@localhost:11222 ①
```
...
```properties
quarkus.infinispan-client.hosts=host1:11222;host2:3122 ①
quarkus.infinispan-client.username=admin
quarkus.infinispan-client.password=password
quarkus.infinispan-client.backup-cluster.nyc-site.hosts=nyc1:11222;nyc2:21222;nyc3:31222 ②
quarkus.infinispan-client.backup-cluster.lon-site.hosts=lon1:11222;lon2:21222;lon3:31222 ③
```
...
Learn more in the [Infinispan documentation](https://infinispan.org/docs/stable/titles/xsite/xsite.html).
</dd></dl>
...
You can find more information on configuring authentication in [Hot Rod Endpoint Authentication Mechanisms](https://infinispan.org/docs/stable/titles/hotrod_java/hotrod_java.html#hotrod_endpoint_auth-hotrod-client-configuration).
...
called [Protostream](https://github.com/infinispan/protostream).

<dl><dt><strong>💡 TIP</strong></dt><dd>

Infinispan caches can store keys and values in different encodings, but recommend using [Protocol Buffers (Protobuf)](https://developers.google.com/protocol-buffers).

For more information see our [Cache Encoding and Marshalling](https://infinispan.org/docs/stable/titles/encoding/encoding.html) guide.
</dd></dl>
...
Check the [Getting started with testing guide](../09-testing/getting-started-testing.md) for more information.
...
Check the [Infinispan Dev Services Guide](https://quarkus.io/guides/infinispan-dev-services) to connect to the Infinispan
Dev Services server.
</dd></dl>
...
please use [Infinispan Operator](https://infinispan.org/docs/infinispan-operator/main/operator.html)
for Kubernetes deployments, Infinispan Console,
[REST API](https://infinispan.org/docs/stable/titles/rest/rest.html#rest_v2_protobuf_schemas) or the
[Hot Rod Java Client](https://infinispan.org/docs/stable/titles/encoding/encoding.html#registering-sci-remote-caches_marshalling).
...
Use or replace your annotations by using the [Infinispan Cache extension](cache-infinispan-reference.md).
...
**📌 NOTE**\
You can read more about [querying](https://infinispan.org/docs/stable/titles/query/query.html) in the Infinispan documentation.
...
You can read more about [clustered counters](https://infinispan.org/docs/stable/titles/developing/developing.html#clustered_counters) in the Infinispan documentation.
...
and/or keystore. This is further detailed [here](https://infinispan.org/docs/stable/titles/hotrod_java/hotrod_java.html#hotrod_encryption).

The Infinispan Client extension enables SSL/TLS by default. You can read more about this
at [Using SSL With Native Executables](https://quarkus.io/guides/native-and-ssl).
...
**📌 NOTE**\
Learn more in the [Infinispan Dev Services guide](https://quarkus.io/guides/infinispan-dev-services).
...
**📌 NOTE**\
La tabla de configuracion generada `quarkus-infinispan-client` se produce al construir la documentacion y no existe en el codigo fuente. Consulta la referencia de configuracion en https://quarkus.io/guides/all-config
