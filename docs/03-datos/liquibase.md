...
> **Guia oficial:** <https://quarkus.io/guides/liquibase>  
> **Fuente:** `docs/src/main/asciidoc/liquibase.adoc` en [quarkusio/quarkus@3.38.2](https://github.com/quarkusio/quarkus/blob/3.38.2/docs/src/main/asciidoc/liquibase.adoc)  
> **Version documentada:** Quarkus 3.38.2 · **Sincronizado:** 2026-08-17 · **Licencia:** Apache-2.0

[Liquibase](https://www.liquibase.org/) is an open source tool for database schema change management.
...
The solution is located in the `liquibase-quickstart` [directory](https://github.com/quarkusio/quarkus-quickstarts/tree/main/liquibase-quickstart).
...
**📌 NOTE**\
La tabla de configuracion generada `quarkus-liquibase` se produce al construir la documentacion y no existe en el codigo fuente. Consulta la referencia de configuracion en https://quarkus.io/guides/all-config
