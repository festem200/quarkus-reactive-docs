...
> **Guia oficial:** <https://quarkus.io/guides/cassandra>  
> **Fuente:** `docs/src/main/asciidoc/cassandra.adoc` en [quarkusio/quarkus@3.38.2](https://github.com/quarkusio/quarkus/blob/3.38.2/docs/src/main/asciidoc/cassandra.adoc)  
...
* A running [Apache Cassandra](https://cassandra.apache.org),
[DataStax Enterprise](https://www.datastax.fr/products/datastax-enterprise) (DSE) or
[DataStax Astra](https://astra.datastax.com) database; or alternatively, a fresh Docker
installation.

## Architecture

This quickstart guide shows how to build a REST application using the
[Cassandra Quarkus extension](https://github.com/datastax/cassandra-quarkus), which allows you to
...
[DataStax Object Mapper](https://docs.datastax.com/en/developer/java-driver/latest/manual/mapper)
...
[quickstart directory](https://github.com/datastax/cassandra-quarkus/tree/main/quickstart) of
...
[`PagingIterable`](https://docs.datastax.com/en/drivers/java/latest/com/datastax/oss/driver/api/core/PagingIterable.html):
...
**❗ IMPORTANT**\
Although this module is called "runtime", it must be declared in the compile scope.
...
* The
[`QuarkusCqlSession`](https://javadoc.io/doc/com.datastax.oss.quarkus/cassandra-quarkus-client/latest/com/datastax/oss/quarkus/runtime/api/session/QuarkusCqlSession.html)
...
When connecting to [DataStax Astra](https://astra.datastax.com), instead of providing a contact
...
from [this file](https://github.com/datastax/cassandra-quarkus/blob/main/quickstart/src/main/resources/META-INF/resources/fruits.html) in it.
...
**💡 TIP**\
 If you are not familiar with Mutiny, please check [Mutiny - an intuitive reactive programming library](../01-fundamentos/mutiny-primer.md).
...
contents from [this file](https://github.com/datastax/cassandra-quarkus/blob/main/quickstart/src/main/resources/META-INF/resources/reactive-fruits.html) in it.
...
[driver manual](https://docs.datastax.com/en/developer/java-driver/latest/manual/core/metrics/).
...
If you installed GraalVM, you can [build a native image](../08-rendimiento-nativo/building-native-image.md) using:
...
fully non-blocking, for example if it uses [reactive routes](../02-web-http/reactive-routes.md).
